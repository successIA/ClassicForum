...
class CategoryDetailView(CategoryViewTest):
    def setUp(self):
        ...
        self.detail_url = reverse(
            "categories:category_detail", kwargs={"slug": self.category.slug}
        )
    ...
    def test_no_thread(self):
        ...
        self.assertEqual(response.context["form"].initial["category"], self.category)
    ...
    def test_many_threads(self):
        ...
        filter_str_url = reverse(
            ...
            kwargs={"slug": self.category.slug, "filter_str": "recent", "page": 2},
        )
